...
import { addcart, removecart } from '../Components/Redux/cartslice/cartslice'

const Cart = () => {
const itemselector=useSelector((state)=>state.cart.items);
const pricesellector=useSelector((state)=>state.cart.totalPrice)
...
<div key={item.id} class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              ...
              <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <button type="button" onClick={()=>dispatch(removecart(item.id))} class="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                    <svg class="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <div class="space-y-4">
            <div class="space-y-2">
              <dl class="flex items-center justify-between gap-4">
                ...
                <dd class="text-base font-medium text-gray-900 dark:text-white">${pricesellector}</dd>
              </dl>
            ...
            <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              ...
              <dd class="text-base font-bold text-gray-900 dark:text-white">${pricesellector}</dd>
            </dl>
          </div>
